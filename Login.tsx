...
const Login: React.FC<LoginProps> = ({ setUser, logo }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f6f6f7] flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-[440px] bg-white rounded-xl shadow-[0_0_0_1px_rgba(0,0,0,0.05),0_4px_12px_rgba(0,0,0,0.1)] p-8 sm:p-12 relative overflow-hidden animate-scale-in">
        {step === 4 && (
