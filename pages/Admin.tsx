...
export const Admin: React.FC<AdminProps> = ({ user, setUser, logo, setLogo }) => {
  ...
  useEffect(() => {
    ...
    // Polling for new messages/tickets
  ...
  const handleTicketSelect = async (id: string) => {
    ...
    if (ticket) {
      await DBService.markMessagesRead(id, 'user'); // Mark user messages as read by admin
  ...
  return (
    <div className="flex h-screen bg-[#f0f2f5] overflow-hidden">
      ...
      <div className="w-[350px] md:w-[400px] bg-white border-r border-gray-200 flex flex-col shrink-0 z-10">
        ...
        {/* Settings Panel */}
        {showSettings && (
            <div className="p-4 bg-gray-50 border-b border-gray-200 transition-all duration-300 ease-in-out">
