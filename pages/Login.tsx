...
export const Login: React.FC<LoginProps> = ({ setUser, logo }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f6f6f7] flex flex-col items-center justify-center p-4">
      ...
      {/* Admin hidden trigger lock icon: removed reference to isLoginPage as it's undefined and unnecessary in this component */}
      {step !== 3 && step !== 4 && (
        <div 
